...
import { ArrowFlights } from './battle/Arrows';
import { poseInto } from './battle/pose';
...
import {
  fighters, arrows, arrowTally, beginBattle, stepBattle, battleOver, battleTime, impacts, guardTally,
  playerStrike, useBattle, alive, fx,
} from '../game/combat';

/**
 * 打起來的樣子。
 *
 * 這個檔留的是<b>什麼時候開打、場上這幾個人擺在哪</b>。
 * 另外兩塊各自成檔:天上的箭 battle/Arrows(沒在打的時候也要掛著,
 * 因為插在地上的箭要留痕),以及姿態 battle/pose ——
 * 那是個純函式,夾在元件中間的時候看起來像元件的一部分,其實不是。
 *
